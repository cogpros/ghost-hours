...
```
=== Participant: ANON-001 | 150 days ===

Total sessions:        772
  Speed:               155
  Unlock:              617
Hugr Hours invested:   1,137h  (142.1 work-days)
Ghost Hours conjured:  20,258h (2,532.2 work-days)
Overall Conjure Rate:  17.8x

Backlog cleared:       203.1 years (self-reported, 218 sessions)
Felt Weight avg:       6.6 / 10 (695 scored)
...
Sources: 710 interactive, 62 scheduled/automated.
```

Real data. One person, using Ghost Hours daily for 150 days. No descriptions, no notes, no project names. Just the math and the felt weight.
<!-- stats:end -->
...
The de-identified export ships in this repo at [`dataset/ghost-hours-export-2026-07-12.json`](dataset/ghost-hours-export-2026-07-12.json): 796 records (772 sessions + 24 methodology notes) from ANON-001, as of 2026-07-12.
<!-- dataset-line:end -->
