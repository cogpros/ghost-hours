...
```
=== Participant: ANON-001 | 199 days ===

Total sessions:        872
  Speed:               166
  Unlock:              706
Hugr Hours invested:   1,339h  (167.4 work-days)
Ghost Hours conjured:  23,258h (2,907.3 work-days)
Overall Conjure Rate:  17.4x

Backlog cleared:       216.6 years (self-reported, 265 sessions)
Felt Weight avg:       6.6 / 10 (795 scored)
...
Sources: 801 interactive, 71 scheduled/automated.
```

Real data. One person, using Ghost Hours daily for 199 days. No descriptions, no notes, no project names. Just the math and the felt weight.
<!-- stats:end -->
...
The de-identified export ships in this repo at [`dataset/ghost-hours-export-2026-08-30.json`](dataset/ghost-hours-export-2026-08-30.json): 896 records (872 sessions + 24 methodology notes) from ANON-001, as of 2026-08-30.
<!-- dataset-line:end -->
