...
<!-- stats:generated by scripts/refresh-dataset.py — edit the script, not this block -->
```
=== Participant: ANON-001 | 149 days ===

Total sessions:        765
  Speed:               155
  Unlock:              610
Hugr Hours invested:   1,124h  (140.5 work-days)
Ghost Hours conjured:  20,053h (2,506.6 work-days)
Overall Conjure Rate:  17.8x

Backlog cleared:       202.2 years (self-reported, 215 sessions)
Felt Weight avg:       6.6 / 10 (688 scored)
...
Sources: 703 interactive, 62 scheduled/automated.
```

Real data. One person, using Ghost Hours daily for 149 days. No descriptions, no notes, no project names. Just the math and the felt weight.
<!-- stats:end -->
...
<!-- dataset-line:generated by scripts/refresh-dataset.py -->
The de-identified export ships in this repo at [`dataset/ghost-hours-export-2026-07-10.json`](dataset/ghost-hours-export-2026-07-10.json): 789 records (765 sessions + 24 methodology notes) from ANON-001, as of 2026-07-10.
<!-- dataset-line:end -->
