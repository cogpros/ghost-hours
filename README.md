...
```
=== Participant: ANON-001 | 159 days ===

Total sessions:        793
  Speed:               159
  Unlock:              634
Hugr Hours invested:   1,188h  (148.6 work-days)
Ghost Hours conjured:  20,943h (2,617.9 work-days)
Overall Conjure Rate:  17.6x

Backlog cleared:       204.5 years (self-reported, 233 sessions)
Felt Weight avg:       6.6 / 10 (716 scored)
...
Sources: 731 interactive, 62 scheduled/automated.
```

Real data. One person, using Ghost Hours daily for 159 days. No descriptions, no notes, no project names. Just the math and the felt weight.
<!-- stats:end -->
...
The de-identified export ships in this repo at [`dataset/ghost-hours-export-2026-07-26.json`](dataset/ghost-hours-export-2026-07-26.json): 817 records (793 sessions + 24 methodology notes) from ANON-001, as of 2026-07-26.
<!-- dataset-line:end -->
