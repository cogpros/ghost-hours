...
```
=== Participant: ANON-001 | 156 days ===

Total sessions:        787
  Speed:               156
  Unlock:              631
Hugr Hours invested:   1,172h  (146.4 work-days)
Ghost Hours conjured:  20,794h (2,599.3 work-days)
Overall Conjure Rate:  17.8x

Backlog cleared:       204.4 years (self-reported, 230 sessions)
Felt Weight avg:       6.6 / 10 (710 scored)
...
Sources: 725 interactive, 62 scheduled/automated.
```

Real data. One person, using Ghost Hours daily for 156 days. No descriptions, no notes, no project names. Just the math and the felt weight.
<!-- stats:end -->
...
The de-identified export ships in this repo at [`dataset/ghost-hours-export-2026-07-19.json`](dataset/ghost-hours-export-2026-07-19.json): 811 records (787 sessions + 24 methodology notes) from ANON-001, as of 2026-07-19.
<!-- dataset-line:end -->
